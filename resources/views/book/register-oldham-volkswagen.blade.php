        ...
        <div class="col-lg-8 p-5">
            <div class="s-card">
                <form action="{{route('book.register.customer')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="s-card shadow-lg bg-white">
                        <div class="s-card-header pb-0 border-0 " style="background: #00437a;">
                            <div class="row display-4 mb-0">
                                <div class="col"><h2 class="text-white fs-120"> Select Your Event: </h2></div>
                                <div class="col text-end "><a href="{{route('book.oldham.volkswagen')}}" class="btn btn-login btn-default px-2 fs-60"><i class="fas fa-angle-double-left"></i> Login</a></div>
                            </div>
                        </div>
                        ...
                        <div class="s-card-body border-0  p-0">
                            <div class="col">
                                ...
                                <div class="js-register-details">
                                    <div class="row">
                                        <div class="s-card-header text-white border-0 px-3" style="background: #00437a;"> Enter Your Details:</div>
                                    </div>
                                    ...
                                    <div class="row s-card-row border-bottom pb-3">
                                        <div class="col-12 bold pt-3">
                                            <button type="submit" name="register_step_1" class="btn btn-volkswagen btn-action brand block fs-110 "> <i class="fas fa-address-card me-1"></i> Register and get code </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
