        ...
        <div class="col-lg-10 mob-px-0">
              <div class="s-card shadow-sm" style="background: #eef0f7; border: 1px solid #ffffff">
                <div class="s-card-body p-3 border-0">
                    ...
                    <form method="POST" action="{{ route('book.reset.code') }}" aria-label="{{ __('Reset Code') }}">
                        @csrf
                        ...
                        <div class="form-group mt-3">
                            <div class="row align-items-center">
                                <div class="col-12 ">
                                    <button type="submit" name="reset_code" class="btn btn-action brand block fs-120"> Reset Code  <i class="fa fa-angle-double-right"></i></button>
                                </div>
