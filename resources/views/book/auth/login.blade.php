                    ...
                    <form method="POST" action="{{ route('book.login') }}" aria-label="{{ __('Admin Login') }}">
                        ...
                        <div class="form-group mt-3">
                            <div class="row align-items-center">
                                <div class="col-md-6 ">
                                    <button type="submit" name="login_step_1" class="btn btn-action brand block fs-130"> <i class="fas fa-user-circle mr-2 "></i> Sign in  </button>
                                </div>
            ...
            <div class="s-card shadow-sm mt-4" style="background: #f8f8f8; border: 1px solid #f1f1f1">
                <div class="s-card-body py-3 px-0 border-0">
                    <div class=" text-center fs-110">
                        Don't have a unique code? Don't worry you can get one through our registration form. <a href="{{route('book.register')}}" name="register_from_login_page" class="text-sister bold ms-1"> Register here  </a>
                    </div>
                </div>
            </div>
