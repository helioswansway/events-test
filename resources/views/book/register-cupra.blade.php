...
@section('styles')
    <style>
            ...
            .btn-honda:hover{
                background: rgba(#003C4A, 0.5)  !important;
                color: #fff !important;
            }
                    ...
                    <div class="s-card shadow-lg bg-light">
                        <div class="s-card-header pb-0 border-0 " style="background: #000000;">
                            <div class="row display-4 mb-0">
                                <div class="col"><h2 class="text-white fs-120" style="padding-top:5px;">Select Your Event: </h2></div>
                                <div class="col text-end pt-1"><a href="{{route('book.cupra')}}" class="btn btn-login btn-default  px-2 dark fs-60"><i class="fas fa-angle-double-left"></i> Login</a></div>
                            </div>
                        </div>
                                ...
                                <div class="js-register-details">
                                    ...
                                    <div class="row s-card-row border-bottom pb-3">
                                        <div class="col-12 bold pt-3">
                                            <button type="submit" name="register_step_1" class="btn btn-action btn-honda block fs-110"> <i class="fas fa-address-card me-1"></i> Register and get code </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
