        ...
        <div class="col-lg-8 p-3">
            <div class="s-card">
                <form action="{{route('book.register.customer')}}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="s-card shadow-lg border rounded bg-white">
                        <div class="s-card-header pb-0 border-0 ">
                            <div class="row display-4 mb-0">
                                <div class="col mob-full-with mob-text-center">
                                    <span class="fs-100"  style="padding-top:5px;">Select Your Event:</span>
                                    <div class="space-10 show-mobile"></div>
                                    <a href="{{route('book.login')}}" class="btn btn-default px-2 sister fs-60 mob-block float-end"> Login <i class="fas fa-angle-double-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="s-card-body border-0  p-0">
                            <div class="col">
                                ...
                                <div class="js-register-details">
                                    <div class="row">
                                        <div class="s-card-header bg-brother border-0 "> Enter Your Details:</div>
                                    </div>
                                    ...
                                    <div class="row s-card-row border-bottom pb-3">
                                        <div class="col-12 bold pt-3">
                                            <button type="submit" name="register_step_1" class="btn btn-action brand block fs-110"> <i class="fas fa-address-card me-1"></i> Register and get code</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
