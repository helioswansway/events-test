...
@section('content')
    ...
    <div class="row justify-content-center">
        <h1 class="display-4 bold mb-0">Booking confirmation details.</h1>
    </div>
    ...
    <div class="row justify-content-center pt-3">
        <a href="{{route('book.confirmation')}}" class="btn btn-action warning btn-radius-md mr-5"><i class="fas fa-arrow-left mr-3"></i>  Back</a>
    </div>
