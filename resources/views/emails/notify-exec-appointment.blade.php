                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left; padding: 20px; color: #003158; font-family: verdana, arial; line-height: 22px;  font-size:14px" valign="top">
                                                                            ...
                                                                            A booking have been made for {{$dealership->name}} Dealership. Login to your <a href="{{url('/admin')}}" style="color:#ec672c;">admin area</a> to view booking details.

                                                                            <br><br>
                                                                            <strong>Dealership:</strong> {{$dealership->name}}<br>
                                                                            <strong>Event:</strong> {{$event->name}} <br>
                                                                            <strong>Customer Name:</strong> {{$book->title}} {{$book->name}} {{$book->surname}}<br>
                                                                            <strong>Date:</strong> {{\Carbon\Carbon::parse($appointment->date)->format('d/M/Y')}} <br>
                                                                            <strong>Time:</strong> {{$time->time}} <br>
                                                                            @if($event->inc_exec == 1)
                                                                                <strong>Exec:</strong> {{$exec->name}}
                                                                            @endif

                                                                            <br><br>

                                                                            If you received this email by mistake please contact <a href="mailto:helio.pinto@swanswaygroup.com">helio.pinto@swanswaygroup.com</a>
