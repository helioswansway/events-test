                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left; padding: 20px; color: #003158; font-family: verdana, arial; line-height: 22px;  font-size:14px" valign="top">
                                                                            ...
                                                                            <p>
                                                                                @if($event->inc_exec == 1)
                                                                                    <strong>{{$exec->name}}</strong> just made a booking with {{$book->title}} {{$book->name}} {{$book->surname}}, please visit <a href="https://swanswayevents.com/admin" style="color:#ec672c;">admin area</a> to view booking details.
                                                                                @else
                                                                                    <strong>{{$book->name}}</strong>  has just confirmed a booking, login to your <a href="https://swanswayevents.com/admin" style="color:#ec672c;">admin area</a> to view booking details.
                                                                                @endif
                                                                            </p>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <strong>Time:</strong> {{$time->time}} <br>
                                                                                @if($event->inc_exec == 1)
                                                                                    <strong>Exec:</strong> {{$exec->name}} <br>
                                                                                @endif
                                                                                <strong>Dealership:</strong> {{$dealership->name}} <br>
                                                                            </p>

                                                                            <p>
                                                                                Regards,<br>
                                                                                {{ str_replace('-', ' ', $config->company_name)}}
                                                                            </p>
