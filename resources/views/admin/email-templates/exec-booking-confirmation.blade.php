                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left; padding: 20px; color: #003158; font-family: verdana, arial; line-height: 22px;  font-size:14px" valign="top">
                                                                            ...
                                                                            <p>
                                                                                <strong>{{$book->name}}</strong>  has just confirmed a booking, login to your <a href="https://swanswayevents.com/exec" style="color:#ec672c;">admin area</a> to view booking details.
                                                                            </p>
