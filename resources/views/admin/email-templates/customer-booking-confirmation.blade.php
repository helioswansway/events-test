                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style="background-color: #ffffff; width:100%">
                                                                            <a href="{{url('/admin')}}" ><img src="{{asset('assets/images/public/general/')}}/{{$event->filename}}" alt="{{$event->name}}" width="599" title="{{$config->company_name}}"></a>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: left; padding: 20px; color: #003158; font-family: verdana, arial; line-height: 22px;  font-size:14px" valign="top">
                                                                            ...
                                                                            <p>Thank you for booking your appointment with {{$dealership->name}}, see details below.</p>
                                                                            ...
                                                                            <p>
                                                                                If you need to speak with us before your appointment, please call us on: <a href="tel:{{$dealership->phone}}" style="color: #ec672c;">{{$dealership->phone}}</a>
                                                                            </p>
