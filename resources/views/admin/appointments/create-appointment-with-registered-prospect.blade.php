...
{{--
    ...
    <form action="{{route('admin.appointment.store')}}" enctype="multipart/form-data" method="POST">
        {{csrf_field()}}
        <input type="hidden" id="event_id" name="event_id" value="{{$event_id}}" >
        <input type="hidden" id="dealership_id" name="dealership_id" value="{{$dealership->id}}" >
        ...
        {{--Appointment Type--}}
            <div class="s-card shadow js-appointment-type mt-5">
                <div class=" s-card-header bg-brother"><i class="fas fa-address-card mr-1"></i>   Appointment Type </div>
                <div class="s-card-body px-3  border-0">
                     <div class="col-12">
                        <div class="bold mt-2">
                            <div class="form-check form-check-inline">
                                <label  class="form-check-label">Make a Booking</label>
                                <input type="radio" id="make_booking" class="form-check-input js-appointment-type" name="appointment_type" value="making-booking">
                            </div>

                            <div class="form-check form-check-inline">
                                <label  class="form-check-label">Register Call</label>
                                <input type="radio" id="register_call" class="form-check-input js-appointment-type" name="appointment_type" value="register-call">
                            </div>
                        </div>
                    </div>
        ...
        {{--END Appointment Type--}}

        {{--Booking Details--}}

            <div class="s-card js-booking-details shadow mt-5">
        ...
        {{--Prospect Progress--}}
            <div class="s-card js-exec-selected js-prospect-progress shadow mt-5">
                ...
                <div class="s-card-body alert-brand px-3 pb-3">
                    ...
                    <div class="row border-top border-bottom">
                        ...
                        <div class="col border-end  py-2">
                            ...
                            <div class="form-check form-check-inline js-confirmed">
...
<script>
    $(function(){
        ...
        $('.js-prospect-progress').hide();
        $('.js-exec-selected').hide()


        $('.js-appointment-type').click(function(){
            var appointment_type = $(this).val();

            //alert(appointment_type)

            $( "#in_progress, #not_interested, #confirm").prop( "checked", false );
            $('.current-date, .current-time, .current-exec').removeClass('active')


            if(appointment_type == 'making-booking'){
                $('.js-booking-details').fadeIn()
                $('.js-exec-selected').fadeOut()
                $('.js-confirmed').show()
                $('.js-in-progress-hide').hide()
                $('html, body').animate({
                    scrollTop: $(".js-booking-details").offset().top
                }, 1000);

            }

            if(appointment_type == 'register-call'){
                $('.js-booking-details').fadeOut()
                $('.js-prospect-progress').fadeIn()
                $('.js-confirmed').hide()
                $('.js-in-progress-hide').show()
                $('html, body').animate({
                    scrollTop: $(".js-prospect-progress").offset().top
                }, 1000);
    ...
    $('.js-submit-appointment').click(function(){
        ...
        if(title == "" || name == "" || surname == "" || email == "" || mobile == "" || address_1 == "" || post_code == ""){
            ...
            //validates Address 1
            if(address_1 == ""){
                $('#address_1').addClass('border-danger').next('.js-error').addClass(' py-1').html('* Address required')
            }else{
                $('#address_1').removeClass('border-danger').next('.js-error').removeClass(' py-1').html('');
            }

            //validates Post Code
            if(post_code == ""){
                $('#post_code').addClass('border-danger').next('.js-error').addClass(' py-1').html('* Post Code required')
            }else{
                $('#post_code').removeClass('border-danger').next('.js-error').removeClass(' py-1').html('');
            }
        }
