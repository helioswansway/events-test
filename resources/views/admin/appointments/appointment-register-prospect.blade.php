                ...
                <div class="row border-top border-bottom">
                    ...
                    <div class="col border-end  py-2">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <input type="checkbox" id="cancelled" class="form-check-input js-cancelled" name="cancelled" value="">
                        </div>
            ...
            $('.js-submit-appointment').click(function(){
               ...
               // alert(title + ", " + name + ", " + surname + ", " + email + ", " + home_phone + ", " + mobile + ", " + address_1 + ", " + address_2 + ", " + address_3 + ", " + address_4 + ", " + address_5 + ", " + post_code)
                ...
                $('body').mousedown(function() {
                    ...
                    $('#friend_name').removeClass('border-danger').next('.js-error py-1').html('');
                });
                ...
                if(title == "" || name == "" || surname == "" || email == "" || mobile == "" || post_code == ""){
                    ...
                    if(mobile == ""){
                        ...
                        if(!mobile.match(/^((\+44\s?|0)7([45789]\d{2}|624)\s?\d{3}\s?\d{3})$/))  {
                            var position = $('#title').offset();
                            $('html, body').animate({scrollTop: position.top}, "slow");
                            $('#mobile').addClass('border-danger').next('.js-error').addClass(' py-1').html('* Invalid mobile number ')
                        }else{
                    ...
                    if($(".current-exec")[0]){
                        ...
                        if($('#friend_interest_yes').is(":checked") && $('#friend_name').val() == ""){
                            ...
                            fetch('/dashboard/appointment/store-prospect',{
                                    method: 'POST',
                                    headers: {
                                ...
                                .then((response) => {
                                    ...
                                    //     $('html, body').animate({scrollTop: position.top}, "slow");
                                    //     $('#email').addClass('border-danger').next('.js-error').html('* Email Already in the current Event')
                        ...
                        //scrool to where the error is
                        var divPosition = $('#exec-group').offset();
                        $('html, body').animate({scrollTop: divPosition.top}, "slow");
                        $('.js-appointment-exec').addClass('border-danger').next('.js-error').html('* Exec needs to be selected')
