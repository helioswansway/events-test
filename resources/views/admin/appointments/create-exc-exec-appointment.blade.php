...
@section('content')
        ...
        <div class="col-12">
            <h1 class="display-4">
                ...
                <span class="h1-button" style="">
                    <a href="{{route('admin.appointment.prospect', [$event_id, $dealership_id] )}}" class="btn btn-sm btn-default brother px-3 py-1 "><i class="fas fa-angle-double-left mr-2"></i> Back</a>
                </span>
            </h1>
        </div>
    </div>
                        ...
                        <div class="col-lg-4 text-center ">
                            ...
                            <div class="bold mt-2">
                                <label for="friend_interest_yes">
                                    <input type="checkbox" id="friend_interest_yes" class="friend-interest" name="friend_interest" value="1" > Yes
                                </label>

                                <label for="friend_interest_no" class="ml-2">
                                    <input type="checkbox" id="friend_interest_no" class="friend-interest" name="friend_interest" value="0" checked > No
                                </label>
                            </div>
    ...
    {{--Part Exchange--}}
        <div class="s-card shadow mt-5">
            ...
            <div class="col-12 border-0 py-4">
                <div class="row ">
                    ...
                    <div class="col-lg-4">
                        <div class="show-vehicle-details mt-3 hide"></div>
                    </div>
            ...
            <div class="s-card-body alert-brand px-3 pb-3">
                ...
                <div class="row bg-white border-top border-bottom">
                    <div class="col-lg-4 bold border-start border-end  pt-3 pb-2">
                        ...
                        <input type="checkbox" id="call_made" class="js-call-made" name="call_made" value="0">
                    ...
                    <div class="col-lg-4 bold  border-end   pt-3 pb-2">
                        ...
                        <input type="checkbox" id="call_back" class="js-call-back" name="call_back" value="0">
                    </div>

                    <div class="col-lg-4 bold  border-end   pt-3 pb-2">
                        <label for="message_left">Message Left</label>

                        <input type="checkbox" id="message_left" name="message_left" value="0">
                    </div>
                ...
                <div class="row border-top border-bottom">
                    ...
                    <div class="col border-end  py-3">
                        <label for="confirm" class="mr-2  text-brand">
                            <input type="checkbox" class="js-confirm" id="confirm" name="confirm" value=""> <small><strong>Confirmed</strong></small>
                        </label>

                        {{--
                            <label for="cancelled" class="mr-2 text-brand">
                                <input type="checkbox" class="js-cancelled" id="cancelled" name="cancelled" value=""> <small><strong> Cancelled</strong></small>
                            </label>
                        --}}
                        <label for="not_interested" class=" text-brand mr-2">
                            <input type="checkbox" class="js-not-interested" id="not_interested" name="not_interested" value=""> <small><strong> Not Interested</strong></small>
                        </label>

                        <label for="js-in-progress" class=" text-brand">
                            <input type="checkbox" class="js-in-progress" id="js-in-progress" name="in_progress" value=""> <small><strong> In Progress</strong></small>
                        </label>


                        <div class="js-appointment-status bg-white rounded border  px-1 py-1 fs-80">
                            Select Appointment Status
                            <input type="checkbox" class="hide"  id="appointment_status" name="appointment_status" checked="checked">
                        </div>

                        {{----}}
                        <div class="js-confirm-status rounded fs-80 alert-success px-2 py-1 hide"> Appointment has been Confirmed </div>

                        <div class="js-cancel-status text-danger rounded fs-80 alert-danger px-2 py-1 hide"> Appointment has been Cancelled </div>
                        <div class="js-not-interested-status text-dark rounded fs-80 alert-warning px-2 py-1 hide"> Customer isn't interested in coming to the Event </div>
                        <div class="js-other-status text-dark rounded fs-80 alert-info px-2 py-1 hide"> Please, make notes of appointment status.</div>
    ...
    <script>
        ...
        $('.js-submit-appointment').click(function(){
            ...
            if($(".current-time")[0]){
                ...
                $('.js-appointment-time').addClass('border-danger').next('.js-error').addClass('text-danger').html('* Time needs to be selected')
