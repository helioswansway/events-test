...
<div class="s-card shadow">
    ...
    <div class="s-card-header bg-brother  hide-mobile fs-90">
        <div class="row">
            ...
            <div class="col-1 border-right text-center px-2">Calls Status</div>
                ...
                <div class="row s-card-row line-height-30">
                    ...
                    <div class="col-4 col-lg-2 border-right border-light text-start text-lg-start pe-1">
                        ...
                        @if(prospectIsBooked($prospect->id))
                            <a href="{{route('admin.edit.appointment', [$prospect->event_id, $dealership->id, $prospect->id])}}" class="mt-1 float-end btn btn-border success text-center px-1 py-0 js-admin-book" title="Edit {{$prospect->title}} {{$prospect->name}} {{$prospect->surname}} Appointment">
                    ...
                    <div class="col-4 col-lg-2 text-center border-right">
                        @if(isset($prospect->appointment->id))
                            ...
                            @if($prospect->appointment->not_interested == 1)
                                <span class="booked-circle alert-info" title="Not Interested"></span>
                            @elseif($prospect->appointment->confirm == 0)
