    ...
    <div class="s-card-body border-0 px-3">
        <div class="row">
            <div class="col-lg-9 px-0">
                ...
                <div class="shadow">
                    <div class="s-card-header border-0">Event Appointments</div>
                    <div class="s-card-header bg-brother">
                        <div class="row border-0 text-white hide-mobile fs-90">
                    ...
                    <div class="s-card-body p-0">
                                ...
                                <div id="accordion" class="accordion-message s-card-body col-12  p-0">
                                    @foreach($appointments as $appointment)
                                        <h3 class="col-12 py-0
                                            ...
                                            @if($appointment->cancelled == 2) alert-cancelled text-danger  @endif
                                            @if($appointment->arrived === 1) alert-arrived text-brand  @endif
                                            @if($appointment->no_show === 1) alert-sister text-brand  @endif
                                            ...
                                            <div class="row s-card-row  line-height-34"  style="border: none;">
                                                <div class="col-lg-2 px-4  border-end bold" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                    {{\Carbon\Carbon::parse($appointment->date)->format('jS')}} {{\Carbon\Carbon::parse($appointment->date)->format('M')}} - @if(!empty($appointment->eventTime->time)) {{$appointment->eventTime->time}} @endif
                                                </div>
                                                ...
                                                <div class="col-2 hide-mobile bold  border-end text-center" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                    @if($appointment->cancelled == 2)
                                                        <div class="text-danger"> Cancelled</div>
                                                    @else

                                                        @if($appointment->arrived == 1)
                                                            <i class="far fa-check-square fs-150 text-success mt-2"></i>
                                                        @else

                                                            @if($appointment->no_show === 1)
                                                                <div class="text-danger"> Didn't Show</div>
                                                            @else
                                                                <div class="row">
                                                                    <div class="col text-start">
                                                                        <a href="javascript:void(0)"  appointment-id="{{$appointment->id}}" class=" btn btn-sm btn-default brand js-arrived fs-80">Arrived</a>
                                                                    </div>

                                                                    <div class="col text-end">
                                                                        <a href="javascript:void(0)"  appointment-id="{{$appointment->id}}" class=" btn btn-sm btn-border sister js-no-show fs-80">No Show</a>
                                                                    </div>
                                                ...
                                                <div class="col-2 hide-mobile text-center">
                                                    @if($appointment->cancelled == 2)
                                                        <i class="far fa-window-close  fs-150 text-danger mt-2" title="Appointment Cancelled"></i>
                                                    @else
                                                        @if($appointment->arrived == 1 || $appointment->no_show == 1)

                                                        @else
                                                                <a href="javascript:void(0)"  appointment-id="{{$appointment->id}}" class="btn btn-sm btn-border sister js-cancelled fs-80">Cancel</a>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="row pb-3">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="swiper-container pb03">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 p-3 border  bg-white">
                                                    <form action="{{route('appointment.update.notes', [$appointment->id])}}" method="POST">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col">
                                                                <button type="submit" name="btnSaveNotes" class="btn btn-default sister"><i class="fas fa-save mr-2"></i> Save Notes</button>
                                                            </div>
                                                            <div class="col text-end">
                                                                <a href="{{route('admin.edit.appointment', [$appointment->event_id, $appointment->dealership_id, $appointment->book_id])}}" class="btn btn-default brother"><i class="far fa-edit fs-110"></i> Edit Appointment</a>
                                                            </div>
                                                        </div>
                        ...
                        @else
                            <div class="col-12 alert-warning bold border border-warning py-2">
                                <i class="fas fa-exclamation-triangle text-warning fs-150 mr-2"></i> No appointments have been yet!
                            </div>
                        @endif
            ...
            <div class="col-lg-3 pb-5">
                <div class="s-card-header bg-brand">Todays availability</div>
                ...
                <div class="s-card-body p-0">
                    ...
                    @else
                        <div class="col text-sister bold py-3 text-center">
                            No dates available!
                        </div>
                    @endif
    ...
    <script>
            $( function() {
                ...
                $('.js-arrived').click(function(){
                    ...
                    $.confirm({
                        title: 'Confirm!',
                        content: 'Are you sure you want to set customer as Arrived?',
                        buttons: {
                            confirm: function (e) {
                                $.ajax({
                                    url: '/dashboard/appointments/reception-log/arrived?appointment_id='+id,
                ...
                $('.js-no-show').click(function(){
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            confirm: function (e) {
                                $.ajax({
                                    url: '/dashboard/appointments/reception-log/no-show?appointment_id='+id,
                                    success:function(response){
                                        console.log(response);
                                        window.location.reload(0);
                                    }
                ...
                $('.js-cancelled').click(function(){
                    ...
                    $.confirm({
                        title: 'Confirm!',
                        content: 'Are you sure you want to set customer as Cancelled?',
                        buttons: {
                            confirm: function (e) {
                                $.ajax({
                                    url: '/dashboard/appointments/reception-log/cancelled?appointment_id='+id,
                                        success:function(response){
                                            // console.log(response);
                                           window.location.reload(0);
                                        }
