        ...
        <div class="col-lg-8 p-0">
            ...
            <div class="s-card shadow">
                ...
                <div class="s-card-body px-3">
                    <form action="{{route('admin.exec.sale.store')}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                        {{ method_field('POST') }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label for="exec_id" class="bold">Sales Exec <span class="text-danger">*</span></label>
                                @if($event->inc_exec == 1)
                                ...
                                @else
                                    ...
                                    <select name="exec_id" id="exec_id" class="form-control form-control-lg" required>
