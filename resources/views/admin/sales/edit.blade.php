        ...
        <div class="col-lg-8 js-appointment p-0">
            ...
            <div class="s-card shadow">
                ...
                <div class="s-card-body px-3 pb-3">
                    ...
                    <form action="{{route('admin.sale.update', [$sale->id] )}}" enctype="multipart/form-data" method="POST">
                        {{csrf_field()}}
                        {{ method_field('POST') }}
                                    ...
                                    <div class="row alert-sister py-3">
                                        ...
                                        <div class="col-lg-4 mt-1">
                                            <div class="form-check">
                                                <div class="row">
                                                    <div class="col-5">
                                                        <input class="form-check-input js-part-exchange-yes" type="radio" name="part_exchange" id="part_exchange_yes" value="1" @if($sale->part_exchange == '1') checked @endif>
                                                        <label class="form-check-label" for="part_exchange_yes">Yes</label>
                                                    </div>
                                                    <div class="col">
                                                        <input class="form-check-input js-part-exchange-no" type="radio" name="part_exchange" id="part_exchange_no" value="0"  @if($sale->part_exchange == '0') checked @endif>
                                        ...
                                        <span class="col-12 js-span  @if($sale->part_exchange == '0') hide @endif">
                                            <div class="row">
                                                <div class="col-12 bold mt-2">
                                                    Enter Registration: <span class="text-danger">*</span>
                                                </div>
                                                <div class="col-lg-4 mt-1">
                                                    <input type="text" class="form-control form-control-lg js-registration" name="registration"  value="{{$sale->registration}}" >
                                                    <span class="js-error text-danger "></span>
                                                </div>
                                            </div>
                                        </span>
