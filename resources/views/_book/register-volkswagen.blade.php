                        ...
                        <div class="s-card-header pb-0 border-0 " style="background: #00437a;">
                            <div class="row display-4 mb-0">
                                <div class="col mob-full-with mob-text-center">
                                    ...
                                    <a href="{{route('book.volkswagen')}}" class="btn btn-login btn-default border-white px-2 sister fs-60 mob-block float-end"> Login <i class="fas fa-angle-double-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
