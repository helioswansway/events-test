<aside class="sideNav shadow" id="sideNav">
    ...
    @else
        <ul class="basic-ul">
            ...
            <li>
                <a href="{{route('book.part.exchange')}}" class="{{ (request()->is('book/part-exchange')) ? 'active' : '' }}" title="Part Exchange Details">
                    <div class="numb">3</div> <span> Part Exchange Details <i class='fas fa-angle-right fs-100'></i></span>
                </a>
            </li>
