...
@section('styles')
    <style>
            ...
            .btn-honda:hover{
                background: rgba(#0f0f0f, 0.5)  !important;
                color: #FFF !important;
            }
                    ...
                    <div class="s-card shadow-lg bg-light">
                        <div class="s-card-header pb-0 border-0 " style="background: #000000;">
                            <div class="row display-4 mb-0">
                                ...
                                <div class="col text-end pt-1"><a href="{{route('book.seat')}}" class="btn btn-login btn-default  px-2 dark fs-60"><i class="fas fa-angle-double-left"></i> Login</a></div>
                            </div>
                        </div>
