                            ...
                            <div class="col text-center">
                                ...
                                <div class="mt-4 border-top pt-3">
                                    ...
                                    <form method="POST" action="{{ route('book.login') }}" aria-label="{{ __('Admin Login') }}">
                                        ...
                                        <a href="javascript:void(0)" name="copy_to_clipboard" id="copyValue" class="btn btn-action sister mob-block js-copy-value me-3"><i class="fa-regular fa-copy mr-1 fs-120"></i> Copy to Clipboard</a>
