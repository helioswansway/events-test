                        ...
                        <div class="form-group mt-3">
                            <div class="row">
                                <div class="col text-start">
                                    <button type="submit" class="btn btn-action btn-audi block fs-130"> <i class="fas fa-user-circle mr-2 "></i> Sign in  </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="s-card shadow-sm mt-4" style="background: #f8f8f8; border: 1px solid #f1f1f1">
                <div class="s-card-body p-3 border-0">
                    <div class="col text-center fs-110">
                        Don't have a unique code? Don't worry you can get one through our registration form. <a href="{{route('book.register.audi')}}" class="text-sister bold ms-1"> Register here  </a>
                    </div>
                </div>
            </div>
        </div>
