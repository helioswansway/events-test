...
@section('content')
        ...
        <div class="col-12">
            <h1 class="display-4 "><i class="fas fa-users"></i> Admins
                ...
                <span class="h1-button" style="">
                    <a href="{{route('admin.register')}}" class="btn btn-sm btn-default sister px-3">New Admin <i class="fas fa-plus"></i></a>
                </span>
            </h1>
        </div>
    </div>
    ...
    <div class="js-results">
        {{----}}@include('vendor.multiauth.admin._results')
    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function fetch_data(page, search){
            $.ajax({
                url: '/admin/fetchData?page='+page + "&keyword=" + search,
                                ...
                                buttons: {
                                    confirm: function (e) {
                                        $.ajax({
                                            success: function (response)
                                            {
                                                var url = '{{ route('deletes.admin', ":id") }}';
