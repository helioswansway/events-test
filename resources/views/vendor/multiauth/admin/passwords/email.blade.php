            ...
            <div class="col-lg-10">
                <div class="s-card shadow text-dark">
                    <h1 class="s-card-header bg-brother fs-110">
                        <i class="fa fa-unlock"></i> Reset {{ ucfirst(config('multiauth.prefix')) }} Password
                        <a href="/admin" class="float-right btn btn-sm btn-border sister">Login <i class="fas fa-sign-in-alt"></i></a>
                    </h1>
