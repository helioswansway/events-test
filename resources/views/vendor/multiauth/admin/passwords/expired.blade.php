        ...
        <div class="col-lg-10">
            ...
            <div class="s-card shadow text-dark mt-5">
                ...
                <div class="s-card-body border-0 px-3 fs-110">
                    ...
                    <form method="POST" action="{{ route('admin.password.updated') }}" aria-label="{{ __('Admin Reset Password' ) }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group ">
                                ...
                                <div class="col-12">
                                    <input id="email" type="email" class="form-control form-control-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{auth('admin')->user()->email}}" disabled>
                                    @if ($errors->has('email'))
