                ...
                @foreach($admins as $admin)
                    ...
                    @else
                        <div class="row s-card-row line-height-34">
                            ...
                            <div class="col-3 border-right fs-90">
                            ...
                            <span class="col text-end">
                                ...
                                <a href="#" class="btn btn-sm btn-border px-1 danger js-delete" item-id="{{$admin->id}}"  title="Delete admin"><i class="fa fa-trash"></i></a>
